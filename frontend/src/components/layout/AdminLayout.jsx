...
import { LayoutDashboard, BookOpen, Users, FileText, CheckSquare, BarChart, Eye, LogOut, Menu, X, Layers, GraduationCap, Shield, Bell, Bookmark, UserX, FileCheck } from 'lucide-react';
...
export default function AdminLayout() {
  ...
  const menuItems = [
    ...
    { name: 'Quản lý Đợt đăng ký KH', path: '/admin/cohort', icon: CheckSquare },
    ...
    { name: 'Xét duyệt khiếu nại', path: '/admin/complaintapprovalmanager', icon: FileCheck },
